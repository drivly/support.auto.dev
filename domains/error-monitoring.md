...
|---------|-------------|
| ErrorPattern has Description | \*:1 |
| ErrorPattern has ErrorRate | \*:1 |
| ErrorPattern has Severity | \*:1 |
| ErrorPattern affects APIProduct | \*:\* |
| ErrorPattern involves DataProvider | \*:\* |
| ErrorPattern has Resolution | \*:1 |
| Alert has Body | \*:1 |
| Alert has DetectedAt | \*:1 |
| ErrorPattern has Alert | 1:\* |
| Fix has Description | \*:1 |
| Fix has CodeChange | \*:1 |
| ErrorPattern has Fix | 1:\* |
